...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 pt-12 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 dark:border-gray-800 pt-8">
          <div className="mb-4 md:mb-0">
            ...
            >
              Esteak<span className="text-blue-500">.dev</span>
            </a>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            © {currentYear} Esteak Ahmed Adnan. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <button 
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 p-3 rounded-full bg-blue-500 text-white shadow-lg hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
