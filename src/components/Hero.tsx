...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center relative pt-20 bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-lg mb-8">
              I create responsive and performant web experiences with modern technologies. 
              Focusing on clean code and user-centered designs.
            </p>
